      ...
      >
        ...
        <nav className="cp-nav" style={{
          ...
          <Link to="/" className="cp-brand" style={{
            ...
            <img src="/public/images/logotipo.jpeg" alt="STP Tours" style={{ height: "32px", borderRadius: "6px" }} />
          </Link>
      ...
      <div className="cp-body">
              ...
              {category.parceiros.map((p) => (
                <article className="cp-partner-card" key={p.nome}>
                  <div className="cp-partner-avatar">
                    {listingFace(p) ? <img src={listingFace(p)} alt={p.nome} /> : p.nome.charAt(0)}
                  </div>
        ...
        <section className="cp-contact-band">
          ...
          <div className="cp-contact-actions">
            <a href="mailto:info@stpTours.st" className="cp-contact-link">
              <Mail size={18} /> info@stpTours.st
            </a>
