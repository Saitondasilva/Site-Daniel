...
import {
  ...
  Users, User, ShieldCheck, Leaf, Star,
  Instagram, Facebook,
    ...
    <>
      ...
      />
       <nav className="nav" aria-label="Navegação principal">
          ...
          <button className="iconButton" aria-label="Fechar menu" onClick={onClose}>
            <X size={20} />
          </button>
        </nav>
    </>
      ...
      <div className="ab-body">
        ...
        <section className="ab-section ab-contact-section">
          ...
          <div className="ab-contact-grid">
            <a href="mailto:info@stpTours.st" className="ab-contact-card">
              <div className="ab-contact-icon"><Mail size={22} /></div>
              <div><p className="ab-contact-label">Email geral</p><p className="ab-contact-val">info@stpTours.st</p></div>
            </a>
            <a href="mailto:parceiros@stpTours.st" className="ab-contact-card">
              <div className="ab-contact-icon"><Users size={22} /></div>
              <div><p className="ab-contact-label">Parcerias</p><p className="ab-contact-val">parceiros@stpTours.st</p></div>
            </a>
