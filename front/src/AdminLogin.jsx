...
export default function AdminLogin() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(false);
    if (!ok) setError("Credenciais inválidas, ou não foi possível ligar ao servidor. Verifica se o backend está a correr.");
  }
  ...
  return (
    <div className="al-root">
      <div className="al-card">
        ...
        <p>Acesso restrito ao gestor do portal STP Tours.</p>
        ...
        <form onSubmit={handleSubmit} noValidate className="al-form">
          <div className="al-field">
            ...
            <div className="al-input-wrap">
              ...
              <input id="al-email" type="email" placeholder="admin@stpTours.st"
