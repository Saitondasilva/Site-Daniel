...
// ─── Destinos turísticos em destaque (secção da home) ───
export const destinos = [
  {
    id: "pico-cao-grande",
    nome: "Pico Cão Grande",
    local: "Parque Natural Obô, São Tomé",
    descricao: "Uma agulha vulcânica de quase 370m que se ergue sobre a floresta tropical — um dos ex-líbris mais fotografados do arquipélago.",
    image: "/images/pico-cao-grande.webp",
  },
  {
    id: "forte-sao-sebastiao",
    nome: "Forte de São Sebastião",
    local: "Cidade de São Tomé",
    descricao: "Fortaleza do século XVI à beira-mar que hoje acolhe o Museu Nacional, com história colonial e vistas sobre a baía.",
    image: "/images/forte-sao-sebastiao.jpg",
  },
  {
    id: "praia-verde",
    nome: "Praia Lagoa Azul",
    local: "Costa Sul, São Tomé",
    descricao: "Águas calmas e cristalinas rodeadas de rocha vulcânica e coqueiros, ideal para mergulho livre e um dia em família.",
    image: "/images/praia-verde-stp.jpg",
  },
];

// ─── Pacotes turísticos oferecidos (secção da home) ───
export const pacotes = [
  {
    id: "pacote-essencial",
    nome: "STP Essencial",
    duracao: "3 dias / 2 noites",
    descricao: "Cidade de São Tomé, Forte de São Sebastião e uma tarde de praia — o primeiro contacto perfeito com a ilha.",
    preco: "Desde 220€ / pessoa",
    image: "/images/forte-sao-sebastiao.jpg",
  },
  {
    id: "pacote-aventura",
    ...
    descricao: "Trilhos no Parque Natural Obô, vista ao Pico Cão Grande e alojamento em eco-lodge no coração da floresta.",
    preco: "Desde 340€ / pessoa",
    image: "/images/pico-cao-grande.webp",
  },
  {
    id: "pacote-ilha-completa",
    nome: "Ilha Completa",
    duracao: "7 dias / 6 noites",
    descricao: "Roteiro completo entre São Tomé e Príncipe: praias, cultura, gastronomia e as melhores excursões do arquipélago.",
    preco: "Desde 690€ / pessoa",
    image: "/images/praia-verde-stp.jpg",
  },
];
